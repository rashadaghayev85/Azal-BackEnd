...
namespace Azal.Controllers
{
    public class TicketController : Controller
    {
       ...
       .ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Purchase(TicketCreateVM request,int count)
        {
            ViewBag.Count = count;
        ...
        [HttpGet]
        public async Task<IActionResult> PurchaseBiznes(int id, int count)
        {
            ViewBag.Count = count;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> PurchaseBiznes(TicketCreateVM request, int count)
        {
            ViewBag.Count = count;
        ...
        public async Task<IActionResult> CheckOutBiznes(TicketCreateVM request)
        {
